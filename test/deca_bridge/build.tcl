...
puts "== DECA bridge->DDR3 test: MAX 10 10M50DAF484C6GES =="

project_new bridge_test -overwrite

set_global_assignment -name FAMILY           "MAX 10"
set_global_assignment -name DEVICE           10M50DAF484C6GES
set_global_assignment -name TOP_LEVEL_ENTITY deca_bridge_test_top
...
set_global_assignment -name SDC_FILE           $here/bridge_test.sdc
source $here/bridge_pins.qsf
...
if {[file exists bridge_test.sta.rpt]} {
    set fh [open bridge_test.sta.rpt]; set sta [read $fh]; close $fh
