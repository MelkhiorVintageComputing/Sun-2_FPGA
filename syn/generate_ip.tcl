...
set_property CONFIG.C_NUM_OF_PROBES {16} [get_ips sun2_ila]
...
if {$got != 16} {
    puts "ERROR: sun2_ila has $got probes, not the 16 asked for -- the"
    puts "       configuration was rejected.  wukong_top.sv drives probe15,"
